...
class SrGAN_RTM():
    ...
    def train_loop(self, n_epochs=200):
        ...
        for epoch in range(1, n_epochs+1):
            ...
            wandb.log({'step':step, 'tr_lab_Dloss': tr_labeled_loss, 'val_lab_Dloss': ts_labeled_loss, 'tr_r2 score': r2_tr, 'val_r2 score': r2_ts, 'learning_rate_D': self.d_optimizer.param_groups[0]['lr'], 'learning_rate_G': self.g_optimizer.param_groups[0]['lr'], 'tr_unlabeled_Dloss':tr_unlabeled_loss , 'tr_fake_Dloss': tr_fake_loss, 'tr_gradient_penalty' : tr_gradient_penalty, 'tr_RTM_loss_D': tr_loss_rtm_D, 'tr_RTM_loss_G': tr_loss_rtm_G, 'tr_loss_G':tr_generator_loss})
