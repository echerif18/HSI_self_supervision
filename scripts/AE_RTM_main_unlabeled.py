...
for percentage_tr in [1]: 
    # Optional: Summarize GPU memory usage
    print(torch.cuda.memory_summary())
    
    # run = 'AE_RTM_{}_{}HFUNlabels_{}'.format(formatted_datetime, percentage_tr*100, seed)
    run = 'AE_RTM_{}_{}UNlabels_{}_New'.format(formatted_datetime, percentage_tr*100, seed)
