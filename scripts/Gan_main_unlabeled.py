...
seed = 140 # 4 155 140 #random.randint(0, 500)
...
for percentage_tr in [1]: #1, 0.8, 0.6, 0.4, 0.2
    ...
    run = 'Gan_NoRTM_{}_{}UNlabels_{}_New'.format(formatted_datetime, percentage_tr*100, seed)
    # run = 'Gan_NoRTM_{}_{}HRUNlabels_{}'.format(formatted_datetime, percentage_tr*100, seed)
